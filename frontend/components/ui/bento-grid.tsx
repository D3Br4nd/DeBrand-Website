...
export const BentoGridItem = ({
    ...
    return (
        <div
            className={cn(
                "row-span-1 rounded-xl group/bento hover:shadow-2xl transition duration-200 shadow-sm p-6 bg-white dark:bg-neutral-900 border justify-between flex flex-col space-y-4",
